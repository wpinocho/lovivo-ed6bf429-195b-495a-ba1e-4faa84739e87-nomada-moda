...
export const FloatingOrbs = () => {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <motion.div
        className="absolute top-1/4 -left-32 w-[40rem] h-[40rem] rounded-full opacity-8 blur-[140px]"
      ...
      <motion.div
        className="absolute bottom-1/4 -right-32 w-[38rem] h-[38rem] rounded-full opacity-6 blur-[130px]"
      ...
      {/* Center Accent Orb */}
      <motion.div
        className="absolute top-1/2 left-1/2 w-80 h-80 rounded-full opacity-6 blur-[110px]"
      ...
      <motion.div
        className="absolute top-10 right-1/4 w-96 h-96 rounded-full opacity-7 blur-[120px]"
      ...
      <motion.div
        className="absolute bottom-1/3 left-1/4 w-[28rem] h-[28rem] rounded-full opacity-5 blur-[100px]"
